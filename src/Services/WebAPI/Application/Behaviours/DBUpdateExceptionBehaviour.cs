    ...
    public class DBUpdateExceptionBehaviour<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
    {
        ...
        public async Task<TResponse> Handle(TRequest request, CancellationToken cancellationToken, RequestHandlerDelegate<TResponse> next)
        {
            ...
            catch (DbUpdateException ex)
            {
                ...
                //probably should propagate the error higher so that it can be properly reported in some way to the client!
                //TODO: do we return here instead of continuing to throw!
                throw;
            }
        }
    }
